            ...
            <section>
                <v-parallax src="./img/land/hero.jpeg" height="600">
                    <v-layout column align-center justify-center class="white--text">
                        ...
                        <div
                            class="subheading mb-3 text-xs-center test-test-test"
                        >Powered by Vuetify</div>
                        <v-btn
                            class="blue lighten-2 mt-5 test-test-test"
                            dark
                            large
                            to="/login"
                        >Get Started</v-btn>
                                ...
                                <v-flex xs12 md4>
                                    <v-card class="elevation-0 transparent">
                                        ...
                                        <v-card-title primary-title class="layout justify-center">
                                            <div
                                                class="headline text-xs-center test-test-test"
                                            >Material Design</div>
                                        </v-card-title>
                                ...
                                <v-flex xs12 md4>
                                    <v-card class="elevation-0 transparent">
                                        <v-card-text class="text-xs-center">
                                            <v-icon
                                                x-large
                                                class="blue--text text--lighten-2 test-test-test"
                                            >build</v-icon>
                                        </v-card-text>
                                        <v-card-title primary-title class="layout justify-center">
                                            <div
                                                class="headline text-xs-center"
                                            >Completely Open Sourced</div>
                                        </v-card-title>
                                        <v-card-text>{{ lorem }}</v-card-text>
                                    </v-card>
                                </v-flex>
