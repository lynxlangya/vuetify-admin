                        ...
                        <v-card class="elevation-5 pa-3">
                            <v-card-text>
                                <div class="layout column align-center">
                                    ...
                                    />
                                    <h1
                                        class="text-xs-center my-4 primary--text"
                                    >Vue Vuetify Admin Template</h1>
                                </div>
                                <v-form>
                                    <v-text-field
                                        append-icon="person"
                            ...
                            <v-card-text fluid fill-height>
                                <v-layout column align-center>
                                    <v-flex xs12>
                                        <v-btn-toggle>
                                            <v-btn flat @click="setUserToLogin(0)" class="warning">
                                                <span>editor</span>
                                            </v-btn>
                                            <v-btn flat @click="setUserToLogin(1)" class="warning">
                                                <span>admin</span>
                                            </v-btn>
                                        </v-btn-toggle>
                                    </v-flex>
